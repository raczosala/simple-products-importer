...
var pluginConfig = {
						'CONF Plugin Name': 'Simple Products Importer', // User friendly plugin name
						'CONF_Plugin_Link': 'https://github.com/raczosala/simple-products-importer.git',
						'CONF_Plugin_Author': 'Oscar Salazar',
						'CONF_Author_Link': 'https://github.com/raczosala/',
						'CONF_Plugin_Copyright': '2016 Oscar Salazar',

						'plugin-name': 'simple-products-importer', // Plugin slug
						'Plugin_Name': 'Simple_Products_Importer', // Classes prefix
						'plugin_name': 'simple_products_importer' // plugin identifier
