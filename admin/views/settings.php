...
<?php
$settings_tabs = Simple_Products_Importer_Settings::$settings_tabs;
?>
...
<div class="wrap">
	...
	<?php foreach( $settings_tabs as $tab_id => $tab ){ ?>
		<a href="#<?php echo $tab_id;?>" class="nav-tab"><?php _e( $tab , 'simple-products-importer' ); ?></a>
	<?php }?>
	</h2>
					...
					<div class="postbox">
						<div class="inside">
							...
							<form id="plugin-settings-form" action="options.php" method="POST">
								<?php
								settings_fields( Simple_Products_Importer_Settings::$settings_group_id );
